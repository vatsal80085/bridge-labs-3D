package ThisStaticFinalKeywordsAndInstanceofOperatorLevel1LabPractice;
...
public class BankAccount {
   ...
   public static void main(String[] args) {
       ...
       BankAccount account1 = new BankAccount("Vatsal Agarwal", "ACC12345", 1000.00);
       BankAccount account2 = new BankAccount("Hinata Shoyo", "ACC67890", 500.00);
